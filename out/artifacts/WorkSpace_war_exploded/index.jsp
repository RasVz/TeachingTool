...
<body>
	...
	<form id="form">
		...
		<div class="block">
			...
			<input name="runningBandID" id="runningBandID" value="4086591" placeholder="工具运行帮区视图ID，用不到可以不填">
		</div>
		<div class="block">
		...
		<div class="block">
			...
			<input name="userName" placeholder="运行工具的用户的用户名，用不到可以不填">
		</div>
		<div class="block">
			<div class="name">用户ID：</div>
			<input name="userID" id="userID" value="69772" placeholder="运行工具的用户ID，用不到可以不填">
		</div>
		<div class="block">
