    ...
    <div class="all">
        <a-radio-group v-model:value="statusFilter" button-style="solid">
            ...
            <div class="action-buttons">
                <a-button type="primary" @click="publishTask" style="margin-right: 10px; background-color: green">
                    发布任务
                </a-button>
                <a-button type="primary" @click="createTask" style="margin-right: 10px; background-color: green">
                    新增任务
                </a-button>
            </div>
        </a-radio-group>
            ...
            <a-form ref="formRef" :model="formState" name="select" autocomplete="off" layout="inline"
                ...
                <div style="display: flex; flex-wrap: wrap">
                    ...
                    <a-form-item label="负责小组" name="task_group" placeholder="请选择负责小组">
                        <a-select v-model:value="formState.task_group" :options="groupOptions" placeholder="选择负责小组"
        ...
        <!-- <ProjectPublishTask :isPublishlTaskVisible="isPublishlTaskVisible" @update:isPublishlTaskVisible="(val) => {
            isPublishlTaskVisible = val;
        }
            " :showCheckbox=" true" /> -->

  <!-- <CreateTaskNew  :modelVisible="isPublishlTaskVisible" @update:modelVisible="(val) => {
            isPublishlTaskVisible = val;
        }
            "   />  -->

        <!-- <ProjectCreateTask :isCreatelTaskVisible="isCreatelTaskVisible" @update:isCreatelTaskVisible="(val) => {
            isCreatelTaskVisible = val;
        }
            " /> -->
...
import ProjectCreateTask from './ProjectCreateTask.vue';
