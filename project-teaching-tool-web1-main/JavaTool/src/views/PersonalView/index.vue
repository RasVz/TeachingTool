<template>
    ...
    >
      ...
      <a-form-item>
        <a-button type="primary" html-type="submit" @click="onOk">Submit</a-button>
      </a-form-item>
    </a-form>
  </template>
  ...
  const onOk = () => {
    formRef.value
        ...
        .then(async values => {
            console.log('Received values of form: ', values);
            console.log('formState: ', toRaw(dynamicValidateForm));
           
            formRef.value.resetFields();
            console.log('reset formState: ', toRaw(dynamicValidateForm));
        })
        .catch(info => {
